...
Have a feature idea? Open a [Feature Request](https://github.com/Ali-Raza-Arain/proj-track/issues/new?template=feature_request.yml) on GitHub.

Want to implement something from this roadmap? Check the [Contributing Guide](https://github.com/Ali-Raza-Arain/proj-track/blob/main/CONTRIBUTING.md) and look for issues labeled [`good first issue`](https://github.com/Ali-Raza-Arain/proj-track/labels/good%20first%20issue).
